...
(lib.moneycopy4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(123).to({regY:92.1,scaleX:1.01,scaleY:0.86,rotation:0,skewX:2.8,skewY:-4.2,x:49.7,y:101.8},22,cjs.Ease.quadIn).to({regY:92.2,skewX:4.5,skewY:-2.5,x:49.4,y:99},10,cjs.Ease.quadIn).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(123).to({regY:94.8,scaleX:1.02,scaleY:0.85,rotation:0,skewX:-1.3,skewY:-7.1,x:47.6,y:102.2},22,cjs.Ease.quadIn).to({regX:48.7,skewX:0.9,skewY:-4.9,x:47.3,y:99.3},10,cjs.Ease.quadIn).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(123).to({regY:94.9,scaleX:1.02,scaleY:0.85,rotation:0,skewX:-4.8,skewY:-9.6,x:48,y:99.7},22,cjs.Ease.quadIn).to({x:47.7,y:96.8},10,cjs.Ease.quadIn).wait(222));
...
(lib.moneycopy2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(128).to({regX:50.4,regY:91.9,scaleX:0.84,scaleY:0.99,skewX:-104.7,skewY:-110.7,x:53,y:144.8},31,cjs.Ease.quadIn).to({skewX:-100,skewY:-106,x:54.9,y:148.8},10).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(127).to({regX:48.8,regY:94.4,scaleX:0.85,scaleY:0.97,rotation:0,skewX:-99.6,skewY:-107.9,x:53.1,y:144.3},31,cjs.Ease.quadIn).to({skewX:-94.9,skewY:-103.1,x:55,y:148.3},10).wait(191));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(126).to({regY:94.6,scaleX:0.87,scaleY:0.96,rotation:0,skewX:-97.9,skewY:-107.4,x:52.9,y:142.1},31,cjs.Ease.quadIn).to({regY:94.5,skewX:-93.2,skewY:-102.7,x:54.9,y:146.1},10).wait(192));
...
(lib.moneycopy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(81).to({regX:50.6,scaleX:0.89,scaleY:1,skewX:10.5,skewY:13.3,x:54.9,y:132.9},15,cjs.Ease.quadIn).wait(9).to({regX:50.5,regY:91.8,scaleX:1,scaleY:1,rotation:158.2,skewX:0,skewY:0,x:239.9,y:-15.7},51,cjs.Ease.quadIn).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(82).to({regX:49,regY:94.7,scaleX:0.89,scaleY:1,rotation:0,skewX:6,skewY:7.6,x:55.1,y:132.4},15,cjs.Ease.quadIn).wait(9).to({regX:48.9,regY:94.6,scaleX:1,scaleY:1,rotation:174,skewX:0,skewY:0,x:304.5,y:63.1},51,cjs.Ease.quadIn).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(83).to({regX:49.2,regY:94.9,scaleX:0.89,rotation:0,skewX:0.5,skewY:0.6,x:55.1,y:129.6},15,cjs.Ease.quadIn).wait(9).to({regX:49.1,regY:94.8,scaleX:1,rotation:160.9,skewX:0,skewY:0,x:350.2,y:26.4},51,cjs.Ease.quadIn).wait(162));
...
(lib.money_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(71).to({regX:50.4,scaleX:0.84,scaleY:0.99,skewX:-97.5,skewY:-103.5,x:53,y:144.8},31,cjs.Ease.quadIn).to({regY:91.9,scaleY:0.99,skewX:-92,skewY:-98.1,x:55,y:148.5},10).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(70).to({regX:48.8,scaleX:0.85,scaleY:0.97,rotation:0,skewX:-103.8,skewY:-112.1,x:53.2,y:144.3},31,cjs.Ease.quadIn).to({regY:94.4,skewX:-98.3,skewY:-106.6,x:55.2,y:148},10).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(69).to({regY:94.7,scaleX:0.87,scaleY:0.96,rotation:0,skewX:-108.6,skewY:-118.1,x:52.9,y:142},31,cjs.Ease.quadIn).to({regY:94.6,skewX:-103.1,skewY:-112.7,x:55.2,y:145.8},10).wait(84));
...
(lib.bg_1 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance_1 = new lib.moneycopy4("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(834.5,593.5,1,1,-167.3,0,0,18.6,134.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(211));

	// Layer_3
	this.instance_2 = new lib.moneycopy2("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(734.5,611.1,1,1,0,0,0,30.4,94);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(211));

	// Layer_2
	this.instance_3 = new lib.moneycopy("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(356.8,707.2,0.945,0.945,94,0,0,30.4,93.9);

	this.instance_4 = new lib.money_1("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(270.2,656.7,1,1,0,0,0,30.4,94);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3}]}).wait(211));
...
(lib.Root = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(185.6,26.9,0.623,0.623,0,0,0,809.1,47.4);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(347.7,320.8,0.623,0.623,0,0,0,544.9,363.7);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({regX:545,scaleX:0.69,scaleY:0.69,x:579.5,y:320.7,alpha:0.781},106,cjs.Ease.quadInOut).wait(59));

	// Layer_6
	this.instance_2 = new lib.brush_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(507.6,367,0.623,0.623,0,0,0,286.3,281.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({regX:286.2,scaleX:0.69,scaleY:0.69,x:755.3,y:371.7},106,cjs.Ease.quadInOut).wait(59));

	// dog
	this.instance_3 = new lib.dog_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(201,318.1,0.623,0.623,0,0,0,310.2,359.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({regX:310.1,regY:359.6,scaleX:0.69,scaleY:0.69,x:418.1,y:317.8},106,cjs.Ease.quadInOut).wait(59));

	// mask
	this.instance_4 = new lib.mask_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(53.3,342.7,0.623,0.623,0,0,0,463,186.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({regX:463.1,regY:186.2,scaleX:0.65,scaleY:0.65,x:46.7,y:346.3,alpha:0},106,cjs.Ease.quadInOut).wait(59));

	// Layer_2
	this.instance_5 = new lib.bg_1("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(185.7,270.4,0.623,0.623,0,0,0,802.5,436.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(10).to({startPosition:10},0).to({regY:436.2,scaleX:0.65,scaleY:0.65,startPosition:116},106,cjs.Ease.quadInOut).wait(59));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86.6,229.4,1087,649);
// library properties:
lib.properties = {
	id: '257EBA36C471426F86DFD947991CC835',
	width: 540,
	height: 540,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:require('./images/bg.jpg?1541930670094'), id:"bg"},
		{src:require('./images/brush.png?1541930670094'), id:"brush"},
		{src:require('./images/dog.png?1541930670094'), id:"dog"},
		{src:require('./images/mask.png?1541930670094'), id:"mask"},
		{src:require('./images/money.png?1541930670094'), id:"money"}
	],
	preloads: []
};
...
an.compositions['257EBA36C471426F86DFD947991CC835'] = {
