...
(lib.Root = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(277,23,0.637,0.637,0,0,0,802.2,43.5);
	...
	this.instance_1.setTransform(277,273.1,0.637,0.637,0,0,0,802.2,435.9);
	...
	this.instance_2.setTransform(277,273.1,0.637,0.637,0,0,0,802.2,435.9);
	...
	this.instance_3.setTransform(277,273.1,0.637,0.637,0,0,0,802.2,435.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(146));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-6.6,226,1110,662);
// library properties:
lib.properties = {
	id: 'D60D12EEA6214AC697F5CCA3644F9D1F',
	width: 540,
	height: 540,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:require('./images/Iron_rod.png?1541930194524'), id:"Iron_rod"},
		{src:require('./images/lamp.jpg?1541930194524'), id:"lamp"},
		{src:require('./images/Prison.jpg?1541930194524'), id:"Prison"},
		{src:require('./images/shadow.png?1541930194524'), id:"shadow"}
	],
	preloads: []
};
...
an.compositions['D60D12EEA6214AC697F5CCA3644F9D1F'] = {
