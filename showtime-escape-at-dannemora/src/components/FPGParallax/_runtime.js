...
// 	if (
// 		this.targetX.toFixed(2) === this.progressDx.toFixed(2) &&
// 		this.targetY.toFixed(2) === this.progressDy.toFixed(2)
// 	) {
...
// 	}
// }
function updateScrollDuration(scene) {
	scene.duration(window.innerHeight - 118);
}
export default function didMount() {
	...
	window.addEventListener('resize', updateScrollDuration.call(this, scene));
}
